...
colabfold-conda/bin/python3.9 -m pip install --no-warn-conflicts "colabfold[alphafold-minus-jax] @ git+https://github.com/ohuelab/ColabFold-cycpep-dock@cyclic_peptide_complex_offset_bugfix"
